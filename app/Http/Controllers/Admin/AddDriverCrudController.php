...
/**
 * Class AddDriverCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class AddDriverCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setRoute(config('backpack.base.route_prefix') . '/adddriver');
        CRUD::setEntityNameStrings('adddriver', 'add_drivers');
    }
    ...
    {
        CRUD::setValidation(AddDriverRequest::class);
