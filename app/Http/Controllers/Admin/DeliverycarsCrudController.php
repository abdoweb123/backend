...
use App\Http\Requests\DeliverycarsRequest;
use Backpack\CRUD\app\Http\Controllers\CrudController;
use Backpack\CRUD\app\Library\CrudPanel\CrudPanelFacade as CRUD;

/**
 * Class DeliverycarsCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class DeliverycarsCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setRoute(config('backpack.base.route_prefix') . '/deliverycars');
        CRUD::setEntityNameStrings('سائق', 'سائقين سيارات التوصيل');
    }
    ...
    protected function setupListOperation()
    {
        $this->crud->addClause('whereHas', 'DriverSpacliy', function($query) {
            $query->where('drivers_specialty_id', '=', '5')
                ->orWhere('drivers_specialty_id', '=', '6')
                ->orWhere('drivers_specialty_id', '=', '8')
                ->orWhere('drivers_specialty_id', '=', '24')
                ->orWhere('drivers_specialty_id', '=', '9');
        });
