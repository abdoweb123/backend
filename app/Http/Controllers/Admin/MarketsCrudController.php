...
/**
 * Class MarketsCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class MarketsCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        $this->crud->addClause('where', 'type_id', '=', '11');
        CRUD::setRoute(config('backpack.base.route_prefix') . '/markets');
        CRUD::setEntityNameStrings('سوق', 'اداره الاسواق');
    }
    ...
    {
        CRUD::setValidation(MarketsRequest::class);
