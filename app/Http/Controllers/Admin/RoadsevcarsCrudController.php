...
use App\Http\Requests\RoadsevcarsRequest;
use Backpack\CRUD\app\Http\Controllers\CrudController;
use Backpack\CRUD\app\Library\CrudPanel\CrudPanelFacade as CRUD;

/**
 * Class RoadsevcarsCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class RoadsevcarsCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setRoute(config('backpack.base.route_prefix') . '/roadsevcars');
        CRUD::setEntityNameStrings('سائق', 'سائقين خدمات الطريق');
    }
    ...
    protected function setupListOperation()
    {
        $this->crud->addClause('whereHas', 'DriverSpacliy', function($query) {
            $query->where('drivers_specialty_id', '=', '10')
                  ->orWhere('drivers_specialty_id', '=', '11')
                  ->orWhere('drivers_specialty_id', '=', '12')
                  ->orWhere('drivers_specialty_id', '=', '15')
                  ->orWhere('drivers_specialty_id', '=', '20')
                  ->orWhere('drivers_specialty_id', '=', '14');
        });
