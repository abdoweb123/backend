...
use App\Http\Requests\RestItemRequest;
use Backpack\CRUD\app\Http\Controllers\CrudController;
use Backpack\CRUD\app\Library\CrudPanel\CrudPanelFacade as CRUD;

/**
 * Class RestItemCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class RestItemCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setRoute(config('backpack.base.route_prefix') . '/restitems');
        CRUD::setEntityNameStrings('منتج', 'اداره منتجات المطاعم ');
    }
    ...
    {
        CRUD::setValidation(RestItemRequest::class);
        $this->crud->setOperationSetting('contentClass', 'col-md-12 bold-labels');
    ...
    public function fetchAdditionalItems()
    {
        return $this->fetch(AdditionalItem::class);
    }
}
