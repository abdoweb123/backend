...
use App\Http\Requests\FurniturecarsRequest;
use Backpack\CRUD\app\Http\Controllers\CrudController;
use Backpack\CRUD\app\Library\CrudPanel\CrudPanelFacade as CRUD;

/**
 * Class FurniturecarsCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class FurniturecarsCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setRoute(config('backpack.base.route_prefix') . '/furniturecars');
        CRUD::setEntityNameStrings('سائق', 'سائقين الاثاث');
    }
    ...
    protected function setupListOperation()
    {
        $this->crud->addClause('whereHas', 'DriverSpacliy', function($query) {
            $query->where('drivers_specialty_id', '=', '19')
                  ->orWhere('drivers_specialty_id', '=', '18')
                  ->orWhere('drivers_specialty_id', '=', '16')
                  ->orWhere('drivers_specialty_id', '=', '17');
        });
