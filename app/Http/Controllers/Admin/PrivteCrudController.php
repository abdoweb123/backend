...
use App\Http\Requests\PrivteRequest;
use Backpack\CRUD\app\Http\Controllers\CrudController;
use Backpack\CRUD\app\Library\CrudPanel\CrudPanelFacade as CRUD;
use App\Http\Requests\DriverRequest;

/**
 * Class PrivteCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class PrivteCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setRoute(config('backpack.base.route_prefix') . '/driver-car');
        CRUD::setEntityNameStrings('سائق', 'سائقين السيارات الخاصه');
    }
    ...
    protected function setupListOperation()
    {
        $this->crud->addClause('whereHas', 'DriverSpacliy', function($query) {
            $query->where('drivers_specialty_id', '=', '3');
        });
