...
class SpecialCarsController extends Controller
{


    public function SpecialCarTypes(){
        $SpecialCar=SpecialCar::where('type',1)->get();
    ...
    function haversineGreatCircleDistance(Request $request){
        ...
        $costpramter= CarSetting::where('id',3)->pluck('byrequest')->first();
        $finalcost=$costpramter+$RequerdEquipment+$car_type_id+$byKelo;
            ...
            $costpramter= CarSetting::where('id',3)->pluck('byhour')->first();
            $fa=$costpramter+$RequerdEquipment+$car_type_id+$byKelo;
            return response()->json(['distance' => $final,
            'Cost' => $fa/1000,
            'est' => $est
            ]);
            ...
            $costpramter= CarSetting::where('id',3)->pluck('price')->first();
            $fa=($costpramter*$final)+$RequerdEquipment+$car_type_id+$byKelo;
            return response()->json(['distance' => $final,
            'Cost' => $fa/1000,
            'est' => $est
            ]);
