...
return [
    ...
    */
    ...
    'scripts' => [
        ...
        'https://backstrap.net/vendors/@coreui/coreui-plugin-chartjs-custom-tooltips/js/custom-tooltips.min.js',
        'https://backstrap.net/vendors/chart.js/js/Chart.min.js',
        'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.10.2/css/all.min.css',
